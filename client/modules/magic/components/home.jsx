...
export default class extends React.Component {
          ...
          <Message size="small" icon floating style={{ marginBottom: "2em" }}>
            ...
            <Message.Content>
              <a
                ...
                href="https://earthref.org/events/MagIC/2023"
              >
                2023 MagIC Workshop: Magnetism and Earth History: Field
                Evolution, Environmental Change and Paleogeography
              </a>
              MagIC is hosting a workshop on February 28th - March 2nd, 2023 in
              La Jolla, CA.
            </Message.Content>
          </Message>
        )}
          ...
          <Grid.Row>
            <Grid.Column width={12}>
              <div className="ui three cards">
                ...
                >
                  ...
                  <div className="subtitle">
                    Browse, combine, and save datasets.
                  </div>
                </IconButton>
                <IconButton
                  className="card"
                ...
                >
                  ...
                  <div className="subtitle">
                    Import data into your private workspace.
                  </div>
                </IconButton>
                <IconButton
                  className="card"
                ...
                >
                  ...
                  <div className="subtitle">
                    Manage your contributions to MagIC.
                  </div>
                </IconButton>
              </div>
              ...
              <div className="ui nine cards" style={{ marginTop: 0 }}>
                ...
                <IconButton
                  className="borderless card"
                  href="https://pmagpy.github.io/PmagPy-docs/intro.html"
                  portal="MagIC"
                >
                  <i className="icons">
                ...
                <IconButton
                  className="borderless card"
                  href="https://www.youtube.com/channel/UC-DbvhEu49a6dZXdvUWorhQ"
                  portal="MagIC"
                >
                  <i className="icons">
                    <i className="tv icon" />
              ...
              <SearchDividedList
                es={_.extend({}, levels[0].views[0].es, {
              ...
              >
                <div className="small title">
                  View More Contributions in the MagIC Search Interface
                </div>
              </IconButton>
            </Grid.Column>
            <Grid.Column width={4}>
  ...
  renderCommunity() {
    return (
      <div>
        <h2 className="ui horizontal divider header">MagIC Community</h2>
        ...
        <div className="ui three stackable cards">
                ...
                <a className="item">
                  ...
                  <div className="content">
                    <h5 className="ui header">
                      Selkin, P.A., Gee, J.S. and Tauxe, L. (2007).
                    </h5>
                    <div className="description">
                      Nonlinear thermoremanence acquisition and implications for
                      paleointensity data. EPSL.
                    </div>
                  </div>
                </a>
                <a className="item">
                ...
                <a className="event item">
                  <div className="content">
                    ...
                    <div className="extra text">
                      Postdoctoral fellowship in paleomagnetism at the Institut
          ...
          <h2 className="ui horizontal divider header">MagIC Links</h2>
          <div className="ui hidden divider"></div>
        </div>
      </div>
    );
