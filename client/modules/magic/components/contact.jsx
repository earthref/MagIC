...
export default class extends React.Component {
  ...
  render() {
    return (
      <div>
        <p>
          <b>Nick Jarboe</b> - <a href="mailto:njarboe@ucsd.edu">njarboe@ucsd.edu</a> - Data Analyst at the Scripps Institution of Oceanography, UC San Diego. <br/>
          ...
          Please contact him for questions about data uploading, problems with the website, data accuracy, questions about the data model, how to install and use the PmagPy software, requests for additions to MagIC's controlled vocabulary lists, requests for new data columns, or questions about the MagIC workshops and related videos.
		    ...
		    <p>
          Nick Jarboe joined the MagIC team in 2011. He has a Ph.D. in Earth Science from UC Santa Cruz with a thesis on the behavior of the magnetic field during the Steens reversal (16.7 Ma) and the precise dating of the reversal using the <sup>40</sup>Ar/<sup>39</sup>Ar method on primarily plagioclase crystals from basalts. <a href="https://orcid.org/0000-0003-1465-9394" target="_blank">Website</a>
        </p>
        <p>
        ...
        <p>
          ...
          <br/>
          <b>Anthony Koppers</b> - <a href="mailto:akoppers@ceoas.oregonstate.edu">akoppers@ceoas.oregonstate.edu</a> - Professor, College of Earth, Ocean and Atmospheric Sciences , Oregon State University.<br/> 
