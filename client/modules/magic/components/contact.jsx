  ...
  render() {
    return (
      <div>
		...
		<p>
          Nick Jarboe joined the MagIC team in 2011. He has a Ph.D. in Earth Science from UC Santa Cruz with a thesis on the behavior of the magnetic field during the Steens reversal (16.7 Ma) and the precise dating of the reversal using the <sup>40</sup>Ar/<sup>39</sup>Ar method on primarily plagioclase crystals from basalts. <Link style={{color: 'purple'}} to={'https://orcid.org/0000-0003-1465-9394'}>Website</Link>
        </p>
        <p>
		...
		<p>
          Please contact her to report software errors and installation problems with the PmagPy software suite. Issues can also be submitted directly on the <Link style={{color: 'purple'}} to={'https://github.com/PmagPy/PmagPy/issues'}>PmagPy GitHub</Link> site. 
        </p>
        <p>
        ...
        <p>
          <b>GitHub</b> - Problems can also be reported directly to the <Link style={{color: 'purple'}} to={'https://github.com/earthref/MagIC/issues'}>MagIC GitHub</Link> site. 
        ...
        <p>
          ...
          Research interests: paleomagnetism and geomagnetism, secular variation and reversals of the geomagnetic field, inverse problems, applications of statistical techniques in geophysics, electrical conductivity of the mantle, paleo and rock magnetic databases. <Link style={{color: 'purple'}} to={'http://scrippsscholars.ucsd.edu/cconstable'}>Website</Link><br/>
          <br/>
