  ...
  render() {
    return (
      <div>
        ...
        <p>
         <b>2019 MagIC Workshop</b><br/>
           We plan to host another workshop in 2019. We like to have at least one day of talks on a related theme. If you have suggestions for the workshop, please feel free to <Link style={{color: 'purple'}} to={'contact'}>email us</Link> with suggestions.<br/>
        </p>
        <p>
