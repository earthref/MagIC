  ...
  'tables': {
    ...
    'locations': {
      ...
      'columns': {
        ...
        'experiment_names': {
          ...
          'validations': ['in("experiments.name")'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'result_type': {
          ...
          'type': 'String',
          'unit': 'Flag',
          'description': 'Individual (i), average (a), model (m) or stacked (s) data',
          'validations': ['cv("data_type")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'data_type'
          }]
        ...
        'result_quality': {
          ...
          'validations': ['cv("data_quality")', 'requiredUnlessTable("sites")']
        },
        'method_codes': {
          'label': 'Method Codes',
          'group': 'Result',
          ...
          'validations': ['cv("method_codes")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'geologic_classes': {
          ...
          'validations': ['cv("class")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'lithologies': {
          ...
          'validations': ['cv("lithology")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'lat_s': {
          ...
          'validations': ['min(-90)', 'max(90)', 'max("end_lat")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'lat_n': {
          ...
          'validations': ['min(-90)', 'max(90)', 'min("begin_lat")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'lon_w': {
          ...
          'validations': ['min(0)', 'max(360)', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'age_low': {
          ...
          'type': 'Number',
          'unit': 'Custom',
          'description': 'Location inferred age, Low range',
          'validations': ['max("age_high")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'age_unit': {
          ...
          'position': 37,
          'type': 'String',
          'description': 'Location inferred age, Age unit',
          'validations': ['cv("age_unit")', 'requiredUnlessTable("sites")'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'dir_tilt_correction': {
          ...
          'notes': 'Correction between geographic (0%) and stratigraphic (100%); unoriented (-1%); partially oriented to horizontal only (-2%); unknown(-3%)',
          'validations': ['min(-3)', 'max(100)', 'requiredIfGroup("Direction")'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'dir_dec': {
          ...
          'validations': ['min(0)', 'max(360)', 'requiredIfGroup("Direction")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'average_dec'
          }, {
        ...
        'dic_inc': {
          ...
          'validations': ['min(-90)', 'max(90)', 'requiredIfGroup("Direction")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'average_inc'
          }, {
        ...
        'pole_lat': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Pole latitude, average of site VGP latitudes',
          'validations': ['min(-90)', 'max(90)', 'requiredIfGroup("Pole")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_lat'
          }, {
        ...
        'pole_lon': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Pole longitude, average of site VGP longitudes',
          'validations': ['min(0)', 'max(360)', 'requiredIfGroup("Pole")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_lon'
          }, {
        ...
        'pole_alpha95': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Pole, Fisher circle',
          'notes': 'Confidence Level = 95%',
          'validations': ['min(0)'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'pole_r': {
          ...
          'type': 'Number',
          'unit': 'Dimensionless',
          'description': 'Pole, Resultant Fisher vector',
          'validations': ['min(0)']
        },
        'pole_k': {
          'label': 'Pole K',
          ...
          'type': 'Number',
          'unit': 'Dimensionless',
          'description': 'Pole, Fisher\'s dispersion parameter Kappa',
          'validations': ['min(0)']
        },
        'pole_conf': {
          ...
          'type': 'Matrix',
          'unit': 'Degrees',
          'urls': ['http://dx.doi.org/10.1029/90JB00448'],
          'description': 'Pole, Confidence ellipse expressed as a six-element colon-delimited list of major axis eta declination, inclinationa and semi-angle followed by minor axis zeta declination, inclinationa and semi-angle',
        ...
        'paleolat': {
          ...
          'validations': ['min(-90)', 'max(90)', 'requiredIfGroup("Paleoposition")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'model_lat'
          }]
        ...
        'paleolon': {
          ...
          'validations': ['min(0)', 'max(360)', 'requiredIfGroup("Paleoposition")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'model_lon'
          }]
        ...
        'pdm': {
          ...
          'type': 'Number',
          'unit': 'Am2',
          'description': 'Paleomagnetic dipole moments, Average of site VDMs',
          'validations': ['requiredIfGroup("PDM")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vdm'
          }]
        ...
        'pdm_n_sites': {
          ...
          'position': 73,
          'type': 'Integer',
          'description': 'Number of sites included in VDM calculations',
          'validations': ['min(0)'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vdm_n'
        ...
        'padm': {
          ...
          'type': 'Number',
          'unit': 'Am2',
          'description': 'Paleomagnetic axial dipole moments, Average of site VDMs',
          'validations': ['requiredIfGroup("PADM")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vadm'
          }]
        ...
        'description': {
          ...
          'position': 77,
          'type': 'String',
          'description': 'Location and result description',
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'pi_names': {
          ...
          'position': 83,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for principal investigators who organized the expedition',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_expeditions',
        ...
        'scientist_names': {
          ...
          'position': 84,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for scientists who described the location',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_locations',
        ...
        'analyst_names': {
          ...
          'position': 85,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for analysts',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'pmag_results',
    ...
    'sites': {
      ...
      'columns': {
        ...
        'location_name': {
          ...
          'description': 'Name for location, dredge or drill site',
          'examples': ['San Francisco Volcanic Province', 'Dredge AMAT02-D12', 'Site 801'],
          'validations': ['in("locations.name")', 'required()'],
          'previous_columns': [{
            'table': 'er_sites',
            'column': 'er_location_name'
          }]
        ...
        'result_type': {
          ...
          'unit': 'Flag',
          'description': 'Individual (i), average (a), model (m) or stacked (s) data',
          'validations': ['cv("data_type")', 'required()'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'data_type'
          }]
        ...
        'method_codes': {
          ...
          'type': 'List',
          'description': 'Colon-delimited list of method codes',
          'validations': ['cv("method_codes")', 'required()'],
          'previous_columns': [{
            'table': 'er_sites',
            'column': 'magic_method_codes'
          }, {
        ...
        'geologic_types': {
          ...
          'position': 13,
          'type': 'List',
          'description': 'Colon-delimited list of geologic types',
        ...
        'lat': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Site position, Latitude',
        ...
        'lat_sigma': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Site position averaging uncertainty, Latitude',
          'notes': 'Standard error or standard deviation at one sigma',
          'validations': ['min(0)', 'max(180)'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'lon': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Site position, Longitude',
        ...
        'lon_sigma': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Site position averaging uncertainty, Longitude',
          'notes': 'Standard error or standard deviation at one sigma',
          'validations': ['min(0)', 'max(360)'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'position_precision': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Site position, Precision in latitude and longitude',
        ...
        'elevation': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site position, Elevation relative to sealevel',
          'notes': 'Meters above sealevel',
          'previous_columns': [{
            'table': 'er_sites',
        ...
        'height': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site position, Stratigraphic height',
        ...
        'core_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site position, Core depth in MBSF',
        ...
        'composite_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site position, Composite depth in MBSF',
          'notes': 'Meters below seafloor',
          'previous_columns': [{
            'table': 'er_sites',
        ...
        'age_low': {
          ...
          'validations': ['max("age_high")', 'requiredUnless("age")'],
          'previous_columns': [{
            'table': 'pmag_sites',
        ...
        'vgp_lat': {
          ...
          'validations': ['min(-90)', 'max(90)', 'requiredIfGroup("VGP")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_lat'
          }]
        ...
        'vgp_lon': {
          ...
          'validations': ['min(0)', 'max(360)', 'requiredIfGroup("VGP")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_lon'
          }]
        ...
        'vdm': {
          ...
          'validations': ['requiredIfGroup("VDM")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vdm'
          }]
        ...
        'vadm': {
          ...
          'validations': ['requiredIfGroup("VADM")'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vadm'
          }]
        ...
        'aniso_type': {
          ...
          'validations': ['requiredIfGroup("Anisotropy")'],
          'previous_columns': [{
            'table': 'rmag_results',
        ...
        'aniso_tilt_correction': {
          ...
          'description': 'Percentage tilt correction applied to the data',
          'notes': 'Correction between geographic (0%) and stratigraphic (100%); unoriented (-1%); partially oriented to horizontal only (-2%); unknown (-3%)',
          'validations': ['min(-3)', 'max(100)', 'requiredIfGroup("Anisotropy")'],
          'previous_columns': [{
            'table': 'rmag_results',
            'column': 'tilt_correction'
          }]
        ...
        'description': {
          ...
          'position': 105,
          'type': 'String',
          'description': 'Site and result description',
          'previous_columns': [{
            'table': 'er_sites',
        ...
        'scientist_names': {
          ...
          'position': 111,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for scientists who described the site',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_sites',
    ...
    'samples': {
      ...
      'columns': {
        ...
        'site_name': {
          ...
          'description': 'Name for site',
          'examples': ['Bas123a'],
          'validations': ['in("sites.name")', 'required()'],
          'previous_columns': [{
            'table': 'er_samples',
            'column': 'er_site_name'
          }]
        ...
        'utc_timestamp': {
          ...
          'position': 5,
          'type': 'Timestamp',
          'description': 'UTC sampling date and time',
          'notes': 'Date and time in the "yyyy:mm:dd:hh:mm:ss.ss" format',
        ...
        'igsn': {
          'label': 'Sample IGSN Number',
          'group': 'Sample',
          'position': 6,
          'type': 'String',
          'description': 'International Geological Sample Number (IGSN)',
        ...
        'azimuth_dec_correction': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Declination correction applied while determining sample azimuth',
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'lat': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Sample position, Latitude',
        ...
        'lat_sigma': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Sample position averaging uncertainty, Latitude',
          'notes': 'Standard error or standard deviation at one sigma',
          'validations': ['min(0)', 'max(180)'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'lon': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Sample position, Longitude',
        ...
        'lon_sigma': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Sample position averaging uncertainty, Longitude',
          'notes': 'Standard error or standard deviation at one sigma',
          'validations': ['min(0)', 'max(360)'],
          'previous_columns': [{
            'table': 'pmag_results',
        ...
        'position_precision': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Sample position, Precision in latitude and longitude',
          'notes': 'Decimal degrees',
          'validations': ['min(0)', 'max(360)'],
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'elevation': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Sample position, Elevation relative to sealevel',
          'notes': 'Meters above sealevel',
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'height': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Sample position, Stratigraphic height',
          'notes': 'Positive is up in section or core, while negative is down relative to reference height',
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'core_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Sample position, Core depth in MBSF',
          'notes': 'Meters below seafloor',
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'composite_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Sample position, Composite depth in MBSF',
          'notes': 'Meters below seafloor',
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'age_unit': {
          ...
          'validations': ['cv("age_unit")', 'requiredUnlessSynthetic()'],
          'previous_columns': [{
            'table': 'pmag_samples',
        ...
        'vgp_n_specimens': {
          'label': 'VGP N Specimens',
          'group': 'VGP',
          'position': 63,
          'type': 'Integer',
          'description': 'Number of specimens included in VGP calculations',
          'validations': ['min(0)'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_n'
        ...
        'scientist_names': {
          ...
          'position': 108,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for scientists who described the sample',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_samples',
    ...
    'specimens': {
      ...
      'columns': {
        ...
        'sample_name': {
          ...
          'description': 'Name for sample',
          'examples': ['Bas123a-01'],
          'validations': ['in("samples.name")', 'required()'],
          'previous_columns': [{
            'table': 'er_specimens',
            'column': 'er_sample_name'
          }, {
        ...
        'mineral_class': {
          ...
          'validations': ['cv("mineral_class_name")'],
          'previous_columns': [{
            'table': 'er_minerals',
        ...
        'vgp_n_measurements': {
          'label': 'VGP N Measurements',
          'group': 'VGP',
          'position': 66,
          'type': 'Integer',
          'description': 'Number of measurements included in VGP calculations',
          'validations': ['min(0)'],
          'previous_columns': [{
            'table': 'pmag_results',
            'column': 'vgp_n'
        ...
        'int_corr_cooling_rate': {
          'label': 'Paleointensity Correction Cooling Rate',
          'group': 'Paleointensity',
          'position': 87,
          'type': 'Number',
          'unit': 'Dimensionless',
        ...
        'int_corr_anisotropy': {
          'label': 'Paleointensity Correction Anisotropy',
          'group': 'Paleointensity',
          'position': 88,
          'type': 'Number',
          'unit': 'Dimensionless',
        ...
        'int_corr_nlt': {
          'label': 'Paleointensity Correction Non-Linear TRM',
          'group': 'Paleointensity',
          'position': 89,
          'type': 'Number',
          'unit': 'Dimensionless',
        ...
        'int_k': {
          'label': 'Paleointensity Arai Curvatute',
          'group': 'Paleointensity Arai Statistics',
          'position': 103,
          'type': 'Number',
          'unit': 'Dimensionless',
        ...
        'critical_temp_type': {
          ...
          'validations': ['cv("temp_type")', 'requiredIfGroup("critical temperature")'],
          'previous_columns': [{
            'table': 'rmag_results',
        ...
        'aniso_type': {
          ...
          'description': 'Anisotropy calculation type',
          'examples': ['AMS', 'AARM', 'AIRM', 'ATRM'],
          'validations': ['cv()', 'requiredIfGroup("Anisotropy")'],
          'previous_columns': [{
            'table': 'rmag_anisotropy',
            'column': 'anisotropy_type'
          }, {
        ...
        'description': {
          ...
          'position': 222,
          'type': 'String',
          'description': 'Specimen and result description',
          'previous_columns': [{
            'table': 'er_specimens',
        ...
        'scientist_names': {
          ...
          'position': 228,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for scientists who described the specimen',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_specimens',
    ...
    'measurements': {
      ...
      'columns': {
        ...
        'experiment_name': {
          ...
          'examples': ['KOPA-299-1', 'KOPA-299-2', 'KOPA-299-6'],
          'validations': ['in("experiments.name")', 'required()'],
          'previous_columns': [{
            'table': 'magic_measurements',
        ...
        'specimen_name': {
          ...
          'description': 'Name for specimen',
          'examples': ['Bas123a-01x'],
          'validations': ['in("specimens.name")', 'required()'],
          'previous_columns': [{
            'table': 'magic_measurements',
            'column': 'er_specimen_name'
          }, {
        ...
        'standard': {
          ...
          'validations': ['cv("measurement_type")', 'required()'],
          'previous_columns': [{
            'table': 'magic_measurements',
        ...
        'treat_dc_field_phi': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Orientation of the lab field with respect for the specimen',
          'previous_columns': [{
            'table': 'magic_measurements',
        ...
        'treat_mw_energy': {
          'label': 'Lab Treatment MW Energy',
          'group': 'Lab Treatments',
          'position': 25,
          'type': 'Number',
          'unit': 'J',
          'description': 'Applied microwave power integrated over total application time',
          'previous_columns': [{
            'table': 'magic_measurements',
        ...
        'magn_x': {
          ...
          'type': 'Number',
          'unit': 'Am2',
          'description': 'Measured magnetic field strength, X'
        },
        'magn_x_sigma': {
          'label': 'Magnetic Field X Sigma',
          'group': 'Raw Measurement',
          'position': 39,
          'type': 'Number',
          'unit': 'Am2',
        ...
        'magn_y': {
          ...
          'type': 'Number',
          'unit': 'Am2',
          'description': 'Measured magnetic field strength, Y'
        },
        'magn_y_sigma': {
          'label': 'Magnetic Field Y Sigma',
          'group': 'Raw Measurement',
          'position': 41,
          'type': 'Number',
          'unit': 'Am2',
        ...
        'magn_z': {
          ...
          'type': 'Number',
          'unit': 'Am2',
          'description': 'Measured magnetic field strength, Z'
        },
        'magn_z_sigma': {
          'label': 'Magnetic Field Z Sigma',
          'group': 'Raw Measurement',
          'position': 43,
          'type': 'Number',
          'unit': 'Am2',
        ...
        'utc_timestamp': {
          ...
          'position': 60,
          'type': 'Timestamp',
          'description': 'UTC Date and time when the measurement occured',
          'notes': 'Date and time in the "yyyy:mm:dd:hh:mm:ss.ss" format',
          'previous_columns': [{
            'table': 'magic_measurements',
    ...
    'criteria': {
      ...
      'columns': {
        ...
        'table_name': {
          'label': 'MagIC Table Name',
          'group': 'Names',
          'position': 2,
          'type': 'Text',
          'description': 'MagIC data model table name',
          'validations': ['cv("magic_table")', 'required()']
        },
        'column_name': {
          ...
          'position': 3,
          'type': 'Text',
          'description': 'MagIC data model column name',
          'validations': ['cv("magic_data_column")', 'required()']
        },
        'criterion_operation': {
    ...
    'ages': {
      ...
      'columns': {
        'location_name': {
          ...
          'description': 'Name for location, dredge or drill site',
          'examples': ['San Francisco Volcanic Province', 'Dredge AMAT02-D12', 'Site 801'],
          'validations': ['in("locations.name")', 'requiredOneInGroup("parent")'],
          'previous_columns': [{
            'table': 'er_ages',
            'column': 'er_location_name'
          }]
        ...
        'site_name': {
          ...
          'description': 'Name for site',
          'examples': ['Bas123a'],
          'validations': ['in("sites.name")', 'requiredOneInGroup("parent")'],
          'previous_columns': [{
            'table': 'er_ages',
            'column': 'er_site_name'
          }]
        ...
        'sample_name': {
          ...
          'description': 'Name for sample',
          'examples': ['Bas123a-01'],
          'validations': ['in("samples.name")', 'requiredOneInGroup("parent")'],
          'previous_columns': [{
            'table': 'er_ages',
            'column': 'er_sample_name'
          }]
        ...
        'specimen_name': {
          ...
          'description': 'Name for specimen',
          'examples': ['Bas123a-01x'],
          'validations': ['in("specimens.name")', 'requiredOneInGroup("parent")'],
          'previous_columns': [{
            'table': 'er_ages',
            'column': 'er_specimen_name'
          }]
        ...
        'age_unit': {
          ...
          'validations': ['cv("age_unit")', 'requiredIfGroup("age")'],
          'previous_columns': [{
            'table': 'er_ages',
            'column': 'age_unit'
          }]
        ...
        'timescale_citations': {
          'label': 'Timescale Definition Citation Names',
          'group': 'Metadata',
          'position': 29,
          'type': 'List',
          'description': 'Colon-delimited list of citation DOIs',
    ...
    'images': {
      ...
      'columns': {
        ...
        'photographer_names': {
          ...
          'position': 13,
          'type': 'List',
          'description': 'Colon-delimited list of EarthRef handles and/or names and emails for photographers',
          'examples': ['@user1:@user2:Not A. Member <no.earthref.handle@gmail.com>'],
          'validations': ['type("users")'],
          'previous_columns': [{
            'table': 'er_images',
