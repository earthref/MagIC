...
export const composer = ({context, elasticsearchQuery}, onData) => {
  ...
  if (Meteor.subscribe('elasticsearch/magic-search-summaries/contribution/_count', elasticsearchQuery).ready()) {
    const doc = Collections.MagICSearchSummariesContributionCount.findOne();
    if (doc !== undefined) {
