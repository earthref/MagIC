...
export const composer = ({context, elasticsearchQuery}, onData) => {
  ...
  if (Meteor.subscribe('elasticsearch/magic-search-summaries/site/_count', elasticsearchQuery).ready()) {
    const doc = Collections.MagICSearchSummariesSiteCount.findOne();
    if (doc !== undefined) {
