...
export const composer = ({context, elasticsearchQuery}, onData) => {
  ...
  if (Meteor.subscribe('elasticsearch/magic-search-images/contribution/_count', elasticsearchQuery).ready()) {
    const doc = Collections.MagICSearchImagesContributionCount.findOne();
    if (doc !== undefined) {
