...
export const composer = ({context, elasticsearchQuery}, onData) => {
  ...
  if (Meteor.subscribe('elasticsearch/magic-search-summaries/location/_count', elasticsearchQuery).ready()) {
    const doc = Collections.MagICSearchSummariesLocationCount.findOne();
    if (doc !== undefined) {
