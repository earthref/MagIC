export const methodCodes = {
  ...
  "lab_treatment": {
    "codes": [{
      ...
      "description": "This check is essentially the same as the zero‐field alteration check. Yet, when conducting in‐field plus zero‐field checks, a comparison of both values indicates possible failures of Thellier's law of additivity.",
      "code": "LT-PMRM-AC",
