export const methodCodes = {
  ...
  "lab_protocol": {
    "codes": [{
      ...
      "code": "LP-PI-TRM-MULT",
      "definition": "Paleointensity experiment: Multi-specimen paleointensity determination"
    }, {
  ...
  "geochronology_method": {
    "codes": [{
      ...
      "code": "GM-CC",
      "definition": "Correlation chronology"
    }, {
      "code": "GM-CC-ARCH",
      "definition": "Correlation chronology: Archeology"
    }, {
      "code": "GM-CC-ARM",
      ...
      "code": "GM-HIST",
      "definition": "Historically recorded geological event"
    }, {
      "code": "GM-INT",
      ...
      "code": "GM-NO",
      "definition": "Unknown geochronology method"
    }, {
      "code": "GM-O18",
  ...
  "sample_characterization": {
    "codes": [{
      ...
      "code": "SC-SSMS",
      "definition": "Sparc source mass spectrometry"
    }, {
      "code": "SC-TITR",
  ...
  "data_adjustment": {
    "codes": [{
      ...
      "code": "DA-DIR-FLAT-EI",
      "definition": "Direction correction: Flattening correction: Elongation/Inclination based - Tauxe and Kent (2013); DOI:10.1029/145GM08 "
    }, {
      "code": "DA-DIR-FLAT-EMP",
      "definition": "Direction correction: Flattening correction: Emperical - Jackson et al. (1991); DOI:10.1111/j.1365-246X.1991.tb02496.x"  
    }, {
      "code": "DA-DIR-GEO",
