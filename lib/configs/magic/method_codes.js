export const methodCodes = {
  ...
  "lab_protocol": {
    ...
    //}, 
    {
      ...
      "urls": ["doi.org/10.1029/2003GC000630"]
    }, {
      "code": "LP-PI-BT-MD",
      ...
      "description": "Paleointensity determined with in-field and in-field steps. Analogous to LP-PI-IZ(infield, zero field) and LP-PI-ZI(zero field, infield). Ref:Thellier, E., and O. Thellier, Sur l'intensite du champ magnetique terrestre dans le passe historique et geologique, Ann. Geophys.,15, 285- 376, 1959",
    }, {
      "code": "LP-PI-IRM",
   ...
   // }, 
    {
      ...
      "urls": ["earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch10.html#PE-PT"]
    }, {
      "code": "LP-PI-REL",
  ...
  "data_adjustment": {
    "codes": [{
      ...
      "code": "DA-DIR-ROT",
      "definition": "Direction correction: Rotation applied"
    }, {
      "code": "DA-DIR-TILT",
      "definition": "Direction correction: Adjusted for tilt"
    }, {
      "code": "DA-DIR-V",
