export const methodCodes = {
  ...
  "sample_orientation": {
    "codes": [{
      ...
      "code": "SO-GAD",
      "definition": "All samples oriented in an arbitrary direction and then corrected assuming GAD direction of 0 or 180 degrees."
    }, {
  ...
  "intensity_estimation": {
    "codes": [{
      ...
      "urls": ["https://doi.org/10.1111/j.1365-246X.1974.tb05443.x","https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch10.html#PE-SH"],
      "code": "IE-SH",
  ...
  "lab_protocol": {
    "codes": [{
      ...
      "code": "LP-AN-DC",
      "definition": "Anisotropy measurement: ARM aquisition with a DC field",
      ...
      "code": "LP-AN-DCP",
      "definition": "Anisotropy measurement: ARM aquisition with a DC field for part of the aquisition",
    ...
    //}, 
    {
      ...
      "code": "LP-PI-BT-IZZI",
      "definition": "Paleointensity experiment: Reciprocity check using an in-field step, followed by a zero-field step",
      "description": "Heating to a specific temperature to remove NRM and then cooling in a known magnetic field to induce TRM. Followed by heating to the same or lower temperature step and then cooling in zero, ambient magnetic field. Yu et al. (2004)",
      ...
      "code": "LP-PI-CA",
      "definition": "Paleointensity experiment in controlled atmosphere"
    }, {
      "code": "LP-PI-CA-AR",
      "definition": "Paleointensity experiment in controlled atmosphere: Argon"
    }, {
      "code": "LP-PI-CA-N",
      "definition": "Paleointensity experiment in controlled atmosphere: Nitrogen"
    }, {
      "code": "LP-PI-CA-VAC",
      "definition": "Paleointensity experiment in controlled atmosphere: Under vacuum"
    }, {
      "code": "LP-PI-CHEM",
   ...
   // }, 
    {
      ...
      "code": "LP-PI-M-IZZI",
      "definition": "Paleointensity experiment: Microwave reciprocity check using an in-field step, followed by a zero-field step",
      "description": "Microwave demagnetization to a specific step to remove NRM and then relaxing in a known magnetic field to induce TRM. Followed by microwave demagnetization to the same or lower step and then relaxing in zero, ambient magnetic field.",
    }, {
      "code": "LP-PI-M-PERP",
      ...
      "code": "LP-QDM",
      "definition": "A SQUID quantum diamond microscope experiment",
      "description": "A quantum diamond SQUID microscope is used to measure the magnetic induction over a sample and then the magnetic moment of the sample can be calculated. Glen, et al. (2017)",
      "urls" : ["https://doi.org/10.1002/2017GC006946"]
    }, {
      "code": "LP-TRM",
