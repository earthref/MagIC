		...
		'specimens': {
			...
			'columns': {
				...
				'meas_orient_theta': {
					...
					'notes': 'Polar angle, colatitude, or zenith angle',
					'validations': ['min(0)', 'max(180)'],
					'previous_columns': [{
						'table': 'rmag_hysteresis',
				...
				'meas_orient_phi': {
					...
					'unit': 'Degrees',
					'description': 'Orientation of specimen in magnetometer',
					'notes': 'Azimuthal angle or longitude',
		...
		'measurements': {
			...
			'columns': {
				...
				'treat_dc_field_theta': {
					...
					'type': 'Number',
					'unit': 'Degrees',
					'description': 'Orientation of the lab field with respect for the specimen during treatment',
					'notes': 'Polar angle, colatitude, or zenith angle',
					'validations': ['min(0)', 'max(180)'],
					'previous_columns': [{
						'table': 'magic_measurements',
				...
				'meas_field_ac_theta': {
					...
					'type': 'Number',
					'unit': 'Degrees',
					'description': 'Orientation of the AC lab field with respect for the specimen during measurement',
					'notes': 'Polar angle, colatitude, or zenith angle',
					'validations': ['min(0)', 'max(180)'],
					'previous_columns': [{
						'table': 'magic_measurements',
				...
				'meas_field_dc_theta': {
					...
					'type': 'Number',
					'unit': 'Degrees',
					'description': 'Orientation of the DC lab field with respect for the specimen during measurement',
					'notes': 'Polar angle, colatitude, or zenith angle',
					'validations': ['min(0)', 'max(180)'],
					'previous_columns': [{
						'table': 'magic_measurements',
