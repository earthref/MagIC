		...
		'sites': {
			...
			'columns': {
				...
				'result_type': {
					...
					'type': 'String',
					'unit': 'Flag',
					'description': '(i) individual site value (an average of samples/specimens), (a) an average value over multiple places thought to be the same, (s) stacked: used for averages of multiple bore hole data, (m) model derived data. ',
