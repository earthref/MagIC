  ...
  'tables': {
      ...
      'columns': {
        ...
        'reference': {
          ...
          'examples': [
            ...
            'https://uni.edu/my_phd_thesis.pdf'
          ],
          'validations': [
            'type("references")'
          ],
    ...
    'locations': {
      ...
      'columns': {
        ...
        'age_unit': {
          ...
          'position': 43,
          'type': 'String',
          'description': 'Location inferred age, Unit',
          'validations': [
            'cv("age_unit")',
            'required()'
          ],
    ...
    'sites': {
      ...
      'columns': {
        ...
        'result_type': {
          ...
          'type': 'String',
          'unit': 'Flag',
          'description': 'An Individual site (i), an average or stack of multiple sites (a), or model derived data (m) ',
          'validations': [
            'cv("data_type")',
            'required()'
          ],
        ...
        'core_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site geographic location, Core depth below seafloor',
        ...
        'composite_depth': {
          ...
          'type': 'Number',
          'unit': 'm',
          'description': 'Site geographic location, Composite below seafloor',
          'notes': 'Meters below seafloor',
          'previous_columns': [
            {
              'table': 'er_sites',
        ...
        'dir_tilt_correction': {
          ...
          'unit': '%',
          'description': 'Percentage tilt correction applied to the data',
          'notes': 'use 0 for geographic directions and 100 for stratigraphically corrected directions; use values inbetween for partially corrected percent; unoriented (-1); partially oriented to horizontal only (-2); unknown(-3)',
          'validations': [
            'min(-3)',
            'max(100)',
            'requiredIfGroup("Direction")'
        ...
        'external_results': {
          ...
          'position': 119,
          'type': 'Matrix',
          'description': 'List of external values associated with a site in the form of key:value:reference; key2:value2:reference2',
          'notes': 'Keys are controlled vocabulary, values are strings, reference should be a doi',
          'examples': [
    ...
    'samples': {
      ...
      'columns': {
        ...
        'dip': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Dip of sample’s X direction measured from the horizontal',
          'validations': [
            'min(-180)',
            'max(180)'
          ],
    ...
    'specimens': {
      ...
      'columns': {
        ...
        'dip': {
          ...
          'type': 'Number',
          'unit': 'Degrees',
          'description': 'Dip of specimen\'s X direction measured from the horizontal',
          'validations': [
            'min(-90)',
            'max(90)'
          ],
        ...
        'critical_temp_type': {
          ...
          'validations': [
            'cv("temp_type")',
            'requiredIfGroup("Critical Temperature")'
          ],
          'previous_columns': [
            {
              'table': 'rmag_results',
    ...
    'measurements': {
      ...
      'columns': {
        ...
        'treat_step_num': {
          'label': 'Lab Treatment Step Number',
          'group': 'Lab Treatments',
          'position': 29,
          'type': 'Integer',
          'description': 'Step number of the treatment',
          'validations': [
            'min(0)'
          ]
        },
