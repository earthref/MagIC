/* Instructions for updating:
    ...
    2) Go to https://jsonformatter.curiousconcept.com/, paste the JSON into the text area, make sure "Fix JSON" is not selected, click "Process", and 
       copy the "formatted JSON Data". The display has funky characters but just click in the box, Ctl-a to select all, and the copy.
...
export const model = {
   ...
   'contribution':{
      ...
      'columns':{
         ...
         'author':{
            ...
            'examples':[
               '@cconstable',
               'Not A. Member <no.earthref.handle@gmail.com>',
               '0000-0002-9000-2100'
            ],
            'validations':[
               'type("users")'
         ...
         'supplemental_links':{
            ...
            'examples':[
               'Geomagnetic Field Model[https://earthref.org/ERDA/1137/]',
         ...
         'description':{
            ...
            'examples':[
               'Fixes errors in latitudes and adds measurement data'
            ],
            'validations':[
               'recommended()'
            ],
   ...
   'locations':{
      ...
      'columns':{
         ...
         'specimens':{
            ...
            'examples':[
               'SFVP01-01a:SFVP01-01b:SFVP02-01a'
            ],
            'validations':[
               'in("specimens.specimen")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_results',
         ...
         'experiments':{
            ...
            'examples':[
               'SFVP01-01a-LT-AF-Z:SFVP01-01b-LT-T-Z:SFVP02-01a-LT-AF-Z'
            ],
            'validations':[
               'in("measurements.experiment")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_results',
         ...
         'geological_province_sections':{
            ...
            'validations':[
               'sv("geological_province_section")'
            ],
            'previous_columns':[
               {
                  'table':'er_locations',
         ...
         'age':{
            ...
            'validations':[
               'requiredUnless("age_low","age_high")',
               'requiredIf("age_sigma")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_results',
         ...
         'pole_conf':{
            ...
            'unit':'Degrees',
            'urls':[
               'http://dx.doi.org/10.1029/JB095iB06p08383'
            ],
         ...
         'pole_vv_q':{
            ...
            'type':'Integer',
            'urls':[
               'http://dx.doi.org/10.1016/0040-1951(90)90116-P'
            ],
         ...
         'int_abs':{
            ...
            'validations':[
               'min(0)',
               'max(0.01)',
               'requiredIf("int_sigma")',
               'requiredIf("int_sigma_perc")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_results',
   ...
   'sites':{
      ...
      'columns':{
         ...
         'specimens':{
            ...
            'description':'Colon-delimited list of the names of specimens included in the result',
            'examples':[
               'SFVP01-01a:SFVP01-01b:SFVP01-02a'
            ],
            'validations':[
               'in("specimens.specimen")'
            ],
         ...
         'experiments':{
            ...
            'description':'Colon-delimited list of the names of experiments included in the result',
            'examples':[
               'SFVP01-01a-LT-AF-Z:SFVP01-01b-LT-T-Z:SFVP01-02a-LT-AF-Z'
            ],
            'validations':[
               'in("measurements.experiment")'
            ],
         ...
         'bed_dip':{
            ...
            'type':'Number',
            'unit':'Degrees',
            'description':'Dip of the bedding as measured to the right of strike direction, that is in the dip direction',
            'previous_columns':[
               {
                  'table':'er_sites',
                  'column':'site_bed_dip'
         ...
         'bed_dip_direction':{
            ...
            'type':'Number',
            'unit':'Degrees',
            'description':'Direction of the dip of a paleo-horizontal plane in the bedding that is in the direction of the dip',
            'validations':[
               'min(0)',
               'max(360)'
            ],
         ...
         'feature_dip':{
            ...
            'type':'Number',
            'unit':'Degrees',
            'description':'Dip of the a feature besides primary bedding as measured to the right of strike direction, that is in the dip direction'
         },
         'feature_dip_direction':{
            'label':'Feature Dip Direction',
            'group':'Geology',
            'position':21,
            'type':'Number',
            'unit':'Degrees',
            'description':'Direction of the dip of a feature besides primary bedding',
            'validations':[
               'min(0)',
               'max(360)'
            ]
         ...
         'feature_type':{
            ...
            'position':22,
            'type':'String',
            'description':'Label for the type of feature that is being given a dip and dip direction',
            'examples':[
               'Dike',
               'Sill',
               'Lineation'
         ...
         'int_abs':{
            ...
            'validations':[
               'min(0)',
               'max(0.01)',
               'requiredIf("int_abs_sigma")',
               'requiredIf("int_abs_sigma_perc")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_sites',
         ...
         'int_rel':{
            ...
            'validations':[
               'requiredIf("int_rel_sigma")',
               'requiredIf("int_rel_sigma_perc")'
            ],
            'previous_columns':[
               {
                  'table':'pmag_sites',
         ...
         'int_rel_ARM':{
            ...
            'validations':[
               'requiredIf("int_rel_ARM_sigma")',
               'requiredIf("int_rel_ARM_sigma_perc")'
            ]
         },
         'int_rel_ARM_sigma':{
         ...
         'int_rel_IRM':{
            ...
            'validations':[
               'requiredIf("int_rel_IRM_sigma")',
               'requiredIf("int_rel_IRM_sigma_perc")'
            ]
         },
         'int_rel_IRM_sigma':{
         ...
         'int_rel_chi':{
            ...
            'validations':[
               'requiredIf("int_rel_chi_sigma")',
               'requiredIf("int_rel_chi_sigma_perc")'
            ]
         },
         'int_rel_chi_sigma':{
         ...
         'aniso_pp':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1016/0040-1951(81)90110-4'
            ],
         ...
         'aniso_ll':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1130/0016-7606(1977)88<1231:SOFSUA>2.0.CO;2'
            ],
         ...
         'aniso_n_samples':{
            'label':'Anisotropy N Samples',
            'group':'Anisotropy',
            'position':125,
            'type':'Integer',
            'description':'Number of samples included in the anisotropy calculations',
            'validations':[
               'min(0)'
            ]
         },
         'aniso_n_specimens':{
            'label':'Anisotropy N Specimens',
            'group':'Anisotropy',
            'position':126,
            'type':'Integer',
            'description':'Number of specimens included in anisotropy calculations',
            'validations':[
               'min(0)'
            ]
         },
         ...
         'external_results':{
            ...
            'examples':[
               'DELTA-O18-SMOW:4.2:10.1126/science.1059412;DELTA-C13-PDB:0.22:10.1126/science.1059412'
            ],
            'validations':[
               'cv("external_result")'
            ]
   ...
   'samples':{
      ...
      'columns':{
         ...
         'experiments':{
            ...
            'description':'Colon-delimited list of the names of experiments included in the result',
            'examples':[
               'SFVP01-03a-LT-AF-Z:SFVP01-03b-LT-AF-Z'
            ],
            'validations':[
               'in("measurements.experiment")'
            ],
   ...
   'specimens':{
      ...
      'columns':{
         ...
         'experiments':{
            ...
            'description':'Colon-delimited list of the names of experiments included in the result',
            'examples':[
               'SFVP01-01a-LT-AF-Z:SFVP01-01a-LT-T-Z'
            ],
            'validations':[
               'in("measurements.experiment")'
            ],
         ...
         'dir_mad_free':{
            ...
            'unit':'Degrees',
            'urls':[
               'http://dx.doi.org/10.1111/j.1365-246X.1980.tb02601.x'
            ],
         ...
         'int_corr_arm':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1111/j.1365-246X.1994.tb03999.x'
            ],
         ...
         'int_b':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1139/p66-090'
            ],
         ...
         'int_f':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1126/science.1057519'
            ],
         ...
         'int_frac':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1029/2003GC000635'
            ],
         ...
         'int_g':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1002/ggge.20062'
            ],
         ...
         'int_k_sse':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1029/2011JB008369'
            ],
         ...
         'int_z_md':{
            ...
            'unit':'Dimensionless',
            'urls':[
               'http://dx.doi.org/10.1029/2004GC000840'
            ],
         ...
         'int_mad_anc':{
            ...
            'unit':'Degrees',
            'urls':[
               'http://dx.doi.org/10.1016/j.epsl.2011.08.024'
            ],
         ...
         'int_drat':{
            ...
            'unit':'%',
            'urls':[
               'http://dx.doi.org/10.1029/2004GC000807'
            ],
         ...
         'int_cdrat':{
            ...
            'unit':'%',
            'urls':[
               'http://dx.doi.org/10.1016/j.pepi.2012.06.005'
            ],
         ...
         'int_n_ptrm':{
            ...
            'type':'Integer',
            'urls':[
               'http://dx.doi.org/10.1029/96JB02115'
            ],
         ...
         'int_dtr':{
            ...
            'unit':'%',
            'urls':[
               'http://dx.doi.org/10.1016/j.epsl.2007.03.017'
            ],
         ...
         'int_n_ptrm_tail':{
            ...
            'urls':[
               'http://dx.doi.org/10.1029/2004GC000807',
               'http://dx.doi.org/10.1016/j.pepi.2004.01.009'
            ],
         ...
         'aniso_s_n_measurements':{
            ...
            'type':'Integer',
            'urls':[
               'http://dx.doi.org/10.2307/2333905'
            ],
         ...
         'rem_ltd_perc':{
            ...
            'unit':'%',
            'urls':[
               'http://dx.doi.org/10.1111/j.1365-246X.2005.02651.x '
            ],
   ...
   'measurements':{
      ...
      'columns':{
         ...
         'files':{
            ...
            'examples':[
               'qdm_context_image[image_file.jpg]'
            ],
            'validations':[
               'cv("file_type")'
            ]
         ...
         'derived_value':{
            ...
            'examples':[
               'XPEEM,2.8,10.1088/1742-6596/430/1/012127'
            ],
            'validations':[
               'cv("derived_value")'
            ]
   ...
   'ages':{
      ...
      'columns':{
         ...
         'tiepoint_height_min':{
            'label':'Tiepoint Stratigraphic Height Min',
            'group':'Tiepoint',
            'position':12,
            'type':'Number',
            'unit':'m',
            'description':'Used for the upper/younger boundary for a tiepoint range',
            'notes':'If the tiepoint is defined as between two heights, use tiepoint_height_min and tiepoint_height_max',
            'examples':[
               '2312',
               '12.53'
            ]
         ...
         'tiepoint_height_max':{
            'label':'Tiepoint Stratigraphic Height Max',
            'group':'Tiepoint',
            'position':13,
            'type':'Number',
            'unit':'m',
            'description':'Used for the lower/older boundary for a tiepoint range',
            'notes':'If the tiepoint is defined as between two heights, use tiepoint_height_min and tiepoint_height_max',
            'examples':[
               '2334',
               '12.78'
   ...
   'images':{
      ...
      'columns':{
         ...
         'title':{
            ...
            'examples':[
               'High tech solutions for being lonely at sea'
            ],
            'validations':[
               'required()'
            ],
