    ...
    'contribution': {
      ...
      'columns': {
        ...
        'reference': {
          ...
          'examples': ['10.1029/92JB01202', '10.1023/A:1015035228810', 'https://uni.edu/my_phd_thesis.pdf'],
    ...
    'samples': {
      ...
      'columns': {
        ...
        'site': {
          ...
          'description': 'Name for site',
          'examples': ['SFVP01'],
          'validations': ['in("sites.site")', 'required()'],
          'previous_columns': [{
            'table': 'er_samples',
            'column': 'er_site_name'
          }, {
        ...
        'orientation_quality': {
          ...
          'validations': ['cv("data_quality")', 'requiredIfGroup("Orientation")'],
          'previous_columns': [{
            'table': 'er_samples',
        ...
        'dir_polarity': {
          ...
          'validations': ['cv("polarity")', 'requiredIfGroup("Direction")'],
          'previous_columns': [{
            'table': 'pmag_samples',
        ...
        'dir_nrm_origin': {
          ...
          'validations': ['cv("nrm")', 'requiredIfGroup("Direction")'],
          'previous_columns': [{
            'table': 'pmag_samples',
            'column': 'sample_nrm'
          }]
    ...
    'specimens': {
      ...
      'columns': {
        ...
        'aniso_type': {
          ...
          'description': 'Anisotropy calculation type',
          'examples': ['AMS', 'AARM', 'AIRM', 'ATRM'],
          'validations': ['cv("anisotropy_type")', 'requiredIfGroup("Anisotropy")'],
          'previous_columns': [{
            'table': 'rmag_anisotropy',
            'column': 'anisotropy_type'
          }, {
