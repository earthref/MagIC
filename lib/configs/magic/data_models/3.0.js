	...
	'sites': {
		...
		'columns': {
			...
			'result_type': {
				...
				'type': 'String',
				'unit': 'Flag',
				'description': '(i) individual site value (an average of samples/specimens), (a) samples/specimens from multiple sampling places that are averaged together, (s) stacked: used for averages of multiple bore hole data, (m) model derived data. ',
