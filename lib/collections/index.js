...
c.collections['magic.private.measurements'] = new Mongo.Collection('magic.private.measurements');
c.collections['magic.private.contributions.summaries'] = new Mongo.Collection('magic.private.contributions.summaries');
c.collections['magic.contributions.summaries'] = new Mongo.Collection('magic.contributions.summaries');
c.collections['magic.import_templates'] = new Mongo.Collection('magic.import_templates');
c.collections['magic.import_templates.read'] = new Mongo.Collection('magic.import_templates.read');
