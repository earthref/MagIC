...
c.add('magic', 'pages'  , 'contributions', 'map'           , {index: 'magic_v5', type: 'contributions_summaries', queries: [{exists: {field: 'BEGIN_LATS'}}]});
...
c.add('magic', 'count'  , 'contributions', 'poles'         , {index: 'magic_v5', type: 'contributions_pmag_results', queries: [{exists: {field: 'POLE_COMP_NAME'}}]});
...
c.add('magic', 'sum'    , 'sites'        , 'summaries'     , {index: 'magic_v5', type: 'contributions_summaries', field: 'N_SITES'                                                              });
c.add('magic', 'sum'    , 'samples'      , 'summaries'     , {index: 'magic_v5', type: 'contributions_summaries', field: 'N_SAMPLES'                                                            });
c.add('magic', 'sum'    , 'specimens'    , 'summaries'     , {index: 'magic_v5', type: 'contributions_summaries', field: 'N_SPECIMENS'                                                          });
...
c.add('magic', 'sum'    , 'locations'    , 'summaries'     , {index: 'magic_v5', type: 'contributions_summaries', field: 'N_LOCATIONS'                                                      });
